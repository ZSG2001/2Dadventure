...
public class Enemy : MonoBehaviour
{
    ...
    private void Update()//持续获得什么东西，放在Update中执行
    {             
        faceDir = new Vector3(-transform.localScale.x, 0, 0);//面朝方向        
        currentState.LogicUpdate();       
        TimeCounter();
    }
    private void FixedUpdate()//物理移动之类的，放在FixedUpdate中
    {
    ...
    private IEnumerator OnHurt(Vector2 dir)    
    {
        ...
        yield return new WaitForSeconds(0.45f);//返回关键词
        isHurt = false;
    }
    #region UnityEvent
    public void OnDie()
    ...
    #endregion
    private void OnDrawGizmosSelected()//绘制BoxCast
    {
